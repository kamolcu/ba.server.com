    ...
    {{ Form::open(array('route' => 'compare', 'class' => 'form-horizontal', 'files' => false, 'id' => 'form_compare')) }}
        <div class="col-xs-12 col-sm-12 col-md-5 col-md-offset-1 panel panel-info">
            ...
            <dl class="dl-horizontal">
                ...
                <dd>{{ Form::text('main_start', '', array('id' => 'main_start', 'class' => 'form-control left-label', 'placeholder' => 'yyyy-mm-dd', 'readonly') ) }}</dd>
            </dl>
            <dl class="dl-horizontal">
                <dt>{{ Form::label('main_end', 'วันสิ้นสุด', array('class' => 'left-label') ) }}:</dt>
                <dd>{{ Form::text('main_end', '', array('id' => 'main_end', 'class' => 'form-control left-label', 'placeholder' => 'yyyy-mm-dd', 'readonly') ) }}</dd>
            </dl>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-5 panel panel-info">
            ...
            <dl class="dl-horizontal">
                ...
                <dd>{{ Form::text('history_start', '', array('id' => 'history_start', 'class' => 'form-control left-label', 'placeholder' => 'yyyy-mm-dd', 'readonly') ) }}</dd>
            </dl>
            <dl class="dl-horizontal">
                <dt>{{ Form::label('history_end', 'วันสิ้นสุด', array('class' => 'left-label') ) }}:</dt>
                <dd>{{ Form::text('history_end', '', array('id' => 'history_end', 'class' => 'form-control left-label', 'placeholder' => 'yyyy-mm-dd', 'readonly') ) }}</dd>
            </dl>
        </div>
    </div>
    {{ Form::close() }}
